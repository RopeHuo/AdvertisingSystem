...
import adgroupRouter from './modules/adgroup'
import adRouter from './modules/ad'
import keywordRouter from './modules/keyword'
import locationRouter from './modules/location'
import adschedulesRouter from './modules/adschedules'
import audiencesRouter  from './modules/audiences'
...
export const constantRoutes = [
  ...
  },
  {
    ...
    redirect: '/recommendations/index',
    component: Layout,
    children: [
      {
        path: 'index',
        ...
        name: 'Documentation',
        meta: { title: '建议', icon: 'documentation', affix: true }
      }
    ]
  },
  {
